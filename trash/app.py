    ...
    if request.method in ['GET', 'POST']:
        ...
        try:
            ...
            if tanimoto_flag == True:
                ...
                # Correction: TruHit labels will NOT BE OPPOSITE!!!
                if tanimoto_flag_dict['TruHit_Counterscreen.ACTIVITY_CLASS'] in neg_class:
                    consensus_prediction_results[processed_smiles]['TruHit Model']['prediction'] = 'INACTIVE'
                    consensus_prediction_results[processed_smiles]['TruHit Model']['probability'] = '1.0'
                if tanimoto_flag_dict['TruHit_Counterscreen.ACTIVITY_CLASS'] in pos_class:
            ...
            ####<IF TANIMOTO==1, THEN SHOW SAME PREDICTION RESULTS AS THAT OF 3CL SIMILARITY TABLE>####
            pos_class = ['MODERATE', 'HIGH']
            neg_class = ['LOW']
            three_cl_tanimoto_flag = None
            three_cl_tanimoto_flag_dict = None

            for key, val in three_cl_similarity_dict[processed_smiles].items():
                if three_cl_similarity_dict[processed_smiles][key]['tanimoto'] == 1:
                    three_cl_tanimoto_flag = True
                    three_cl_tanimoto_flag_dict = three_cl_similarity_dict[processed_smiles][key]
                    break

            if three_cl_tanimoto_flag == True:
                if three_cl_tanimoto_flag_dict['3CL_enzymatic_activity.ACTIVITY_CLASS'] in neg_class:
                ...
                if three_cl_tanimoto_flag_dict['3CL_enzymatic_activity.ACTIVITY_CLASS'] in pos_class:
            ...
            if drug_central_name!='-':
                ...
                pass
            # print('Check drug_central_name: ', synonyms_modified)
